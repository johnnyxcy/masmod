// Auto Generate at 2022-12-08 13:53:25.247983
#include <cmath>
#include <string>
#include <any>
#include <map>
...
double __else__bool_1__ipred__wrt_theta_V;
double __else__bool_1__ipred__wrt_theta_Cl;
double __else__bool_1__ipred__wrt_theta_ka;
double __else__bool_1__ipred__wrt_theta_alag;
double __else__bool_1__ipred__wrt_eta_Cl;
double __else__bool_1__ipred__wrt_eta_V;
double __else__bool_1__ipred__wrt_eta_ka;
double __else__bool_1__ipred__wrt_eta_alag;
int __else__bool_1__ipred__wrt_eps_prop;
int __else__bool_1__ipred__wrt_eps_add;
...
__else__bool_1__ipred__wrt_theta_V = (((((((((-1*self__dose)*pow(self__theta_V, -2))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp((-1*self__eta_V)))*exp(self__eta_ka))+(((((((((-1*self__dose)*self__theta_Cl)*pow(self__theta_V, -3))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -2))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka)))+(((((((((self__dose*self__theta_Cl)*pow(self__theta_V, -3))*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka))*exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))));
__else__bool_1__ipred__wrt_theta_Cl = ((((((((self__dose*pow(self__theta_V, -2))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -2))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka))+(((((((((-1*self__dose)*pow(self__theta_V, -2))*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka))*exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))));
__else__bool_1__ipred__wrt_theta_ka = (((((((self__dose*pow(self__theta_V, -1))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp((-1*self__eta_V)))*exp(self__eta_ka))+(((((((-1*self__dose)*pow(self__theta_V, -1))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -2))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp((-1*self__eta_V)))*exp((2*self__eta_ka))))+(((((((self__dose*pow(self__theta_V, -1))*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*exp((-1*self__eta_V)))*exp((2*self__eta_ka)))*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka)))));
__else__bool_1__ipred__wrt_theta_alag = ((((((self__dose*pow(self__theta_V, -1))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*(((((-1*self__theta_ka)*exp(self__eta_alag))*exp(self__eta_ka))*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+(((((self__theta_Cl*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))*exp(self__eta_alag))*exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V)))))))*exp((-1*self__eta_V)))*exp(self__eta_ka));
__else__bool_1__ipred__wrt_eta_Cl = (((((((((self__dose*self__theta_Cl)*pow(self__theta_V, -2))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -2))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka))+((((((((((-1*self__dose)*self__theta_Cl)*pow(self__theta_V, -2))*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka))*exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))));
__else__bool_1__ipred__wrt_eta_V = (((((((((-1*self__dose)*pow(self__theta_V, -1))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp((-1*self__eta_V)))*exp(self__eta_ka))+(((((((((-1*self__dose)*self__theta_Cl)*pow(self__theta_V, -2))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -2))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka)))+(((((((((self__dose*self__theta_Cl)*pow(self__theta_V, -2))*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*exp(self__eta_Cl))*exp(((-1*2)*self__eta_V)))*exp(self__eta_ka))*exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))));
__else__bool_1__ipred__wrt_eta_ka = ((((((((self__dose*pow(self__theta_V, -1))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp((-1*self__eta_V)))*exp(self__eta_ka))+(((((((-1*self__dose)*pow(self__theta_V, -1))*pow(self__theta_ka, 2))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -2))*((-1*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V))))))*exp((-1*self__eta_V)))*exp((2*self__eta_ka))))+(((((((self__dose*pow(self__theta_V, -1))*pow(self__theta_ka, 2))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*exp((-1*self__eta_V)))*exp((2*self__eta_ka)))*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka)))));
__else__bool_1__ipred__wrt_eta_alag = ((((((self__dose*pow(self__theta_V, -1))*self__theta_ka)*pow(((self__theta_ka*exp(self__eta_ka))+((((-1*self__theta_Cl)*pow(self__theta_V, -1))*exp(self__eta_Cl))*exp((-1*self__eta_V)))), -1))*((((((-1*self__theta_alag)*self__theta_ka)*exp(self__eta_alag))*exp(self__eta_ka))*exp((((-1*self__theta_ka)*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_ka))))+((((((self__theta_Cl*pow(self__theta_V, -1))*self__theta_alag)*exp(self__eta_Cl))*exp((-1*self__eta_V)))*exp(self__eta_alag))*exp((((((-1*self__theta_Cl)*pow(self__theta_V, -1))*(t+((-1*self__theta_alag)*exp(self__eta_alag))))*exp(self__eta_Cl))*exp((-1*self__eta_V)))))))*exp((-1*self__eta_V)))*exp(self__eta_ka));
__else__bool_1__ipred__wrt_eps_prop = 0;
__else__bool_1__ipred__wrt_eps_add = 0;
__bool_1__ipred = 0;
// if alag > t:
// if alag > t:
if (__bool_1)
...
__local["__else__bool_1__ipred__wrt_theta_V"] = __else__bool_1__ipred__wrt_theta_V;
__local["__else__bool_1__ipred__wrt_theta_Cl"] = __else__bool_1__ipred__wrt_theta_Cl;
__local["__else__bool_1__ipred__wrt_theta_ka"] = __else__bool_1__ipred__wrt_theta_ka;
__local["__else__bool_1__ipred__wrt_theta_alag"] = __else__bool_1__ipred__wrt_theta_alag;
__local["__else__bool_1__ipred__wrt_eta_Cl"] = __else__bool_1__ipred__wrt_eta_Cl;
__local["__else__bool_1__ipred__wrt_eta_V"] = __else__bool_1__ipred__wrt_eta_V;
__local["__else__bool_1__ipred__wrt_eta_ka"] = __else__bool_1__ipred__wrt_eta_ka;
__local["__else__bool_1__ipred__wrt_eta_alag"] = __else__bool_1__ipred__wrt_eta_alag;
__local["__else__bool_1__ipred__wrt_eps_prop"] = __else__bool_1__ipred__wrt_eps_prop;
__local["__else__bool_1__ipred__wrt_eps_add"] = __else__bool_1__ipred__wrt_eps_add;
